...
static char fontEmoji[]       = "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true";
...
static Button buttons[] = {
	...
	{ ClkWinTitle,          0,              Button2,        spawndefault,   { 0 } },
    ...
    { ClkTagBar,            0,              Button4,        shiftviewjump,  { .i = -1 } },
	{ ClkTagBar,            0,              Button5,        shiftviewjump,  { .i = +1 } },
